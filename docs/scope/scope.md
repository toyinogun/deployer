...
spec [0008](../specs/0008-workload-isolation-network-policy/index.md)
- [x] Design it (spec): `/architect workload isolation & network policy`
- [ ] Build it: `/develop workload isolation & network policy`
  - [ ] The blocked CIDR config and the two composed policies — AC-1, AC-2, AC-3, AC-4, AC-5, AC-14
  - [ ] The reconcile write, before the workload, failing closed — AC-11, AC-13
  - [ ] The probe app and the fence proved live on the cluster — AC-6, AC-7, AC-8, AC-9, AC-10, AC-19
  - [ ] The startup policy sweep over existing app namespaces — AC-12
  - [ ] The build namespace policy, its drift pin, and the structural tests — AC-15, AC-16, AC-17, AC-18, AC-20
