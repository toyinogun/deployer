...
- [ ] Verify it: `/check verify connecting a client that will not hold a token`
- [ ] Test it: `/test connecting a client that will not hold a token`
- [ ] Review it (fresh model): `/check review connecting a client that will not hold a token`
